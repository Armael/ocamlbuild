...
module Findlib = Ocamlbuild_pack.My_findlib
...
let pflag = Ocamlbuild_pack.Flags.pflag ?doc_param:None
let mark_tag_used = Ocamlbuild_pack.Flags.mark_tag_used
let flag_and_dep = Ocamlbuild_pack.Flags.flag_and_dep
let pflag_and_dep = Ocamlbuild_pack.Flags.pflag_and_dep ?doc_param:None
